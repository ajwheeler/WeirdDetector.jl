This code implements the algorithm in [Wheeler & Kipping 2019]().  Find posterior samples from the paper at [github.com/coolworlds/WDdata](https://github.com/ajwheeler/WDdata).
